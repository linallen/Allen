...
import allen.arff.Feature;
import allen.base.common.*;
import allen.base.feature.*;
import allen.base.module.*;

/**
 * New Arff class for manipulating Arff objects, including loading and saving
 * ARFF file, converting CSV to ARFF, alerting, splitting, swapping, and
 * deleting ARFF features, etc.
 * 
 * @author Allen Lin, 16 Jun 2016
 */
public class ArffNew extends AAI_Module {
	private static final long serialVersionUID = -6129751140714590654L;
	...
	public ArffNew(AAI_Module owner) {
		owner(owner);
	}
	...
	public void merge(ArffNew arff) {
	...
	public static void main(String[] args) throws Exception {
		ArffNew module = new ArffNew(null);
		System.out.println("\n" + ArffNew.version());
		if (args.length == 0) {
			System.out.println(ArffNew.help() + "\n");
			return;
		}
